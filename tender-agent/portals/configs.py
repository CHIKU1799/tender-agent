...
PORTALS: dict[str, PortalConfig] = {
    ...
    # ── Karnataka KPPP ───────────────────────────────────────────────────────
    "kppp_karnataka": PortalConfig(
        portal_id    = "kppp_karnataka",
        display_name = "Karnataka KPPP (kppp.karnataka.gov.in)",
        base_url     = "https://kppp.karnataka.gov.in",
        platform     = "kppp",
        category     = "State",
        results_url  = "https://kppp.karnataka.gov.in/supplier-registration-service/v1/api/portal-service/search-eproc-tenders",
        emoji        = "🌿",
        notes        = "Clean REST API — no CAPTCHA, no Playwright; 3 categories: GOODS/WORKS/SERVICES",
    ),
