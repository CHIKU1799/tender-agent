...
PORTALS: dict[str, PortalConfig] = {
    ...
    "bhel": PortalConfig(
        ...
        emoji        = "⚙️",
        notes        = "SAP Ariba-based platform — DNS failures reported",
        enabled      = False,  # DNS resolution failures
    ),
