...
from core.orchestrator import _make_agent as make_agent_impl
...
# ── Agent factory (delegates to orchestrator for full platform coverage) ──────

def make_agent(portal_id: str, session: BrowserSession, scope: str = "active"):
    return make_agent_impl(portal_id, session, scope)
